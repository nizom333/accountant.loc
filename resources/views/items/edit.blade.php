				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
                        ...
                        <?foreach($menu['MENU'] as $item){?>
                            <li class="<?=($_GET['category_id'] == $menu['ITEM']->CATEGORY_ID)?('active'):('')?>">
                                <a style="background:#fff;" class="has-arrow waves-effect waves-dark" href="/categoty/<?=$item['ID']?>" aria-expanded="false">
